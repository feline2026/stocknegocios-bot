...
class VisualSiteHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if produto and produto[0]:
            ...
            link_olx = f"https://www.olx.com.br/autos-e-pecas/carros-vans-e-utilitarios?q={termo_olx}"
            ...
            <div class="box-botoes">
                ...
                <a href="{link_olx}" target="_blank" class="btn" style="background-color: #6E0AD6; color: white;">🚘 Buscar na OLX Autos</a>
